...
// KDockManager arranges dock leaves through one root split-tree and tabbed panes.
...
private:
    ...
    // Collapses empty split-tree leaves and hides their areas without deleting widgets.
