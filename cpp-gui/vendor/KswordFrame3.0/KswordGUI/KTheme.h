...
// Returns the shared flat box type that fills with the widget color and strokes
// a 1px themed border. Editable/selectable controls (inputs, choices, sliders,
// value fields, progress) use it so they stay visible on same-colored panels and
// match the app's flat-with-border language. Registered by InitFlatThemeGlobal().
