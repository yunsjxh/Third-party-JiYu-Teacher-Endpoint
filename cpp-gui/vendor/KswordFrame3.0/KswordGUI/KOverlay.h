...
class KToast : public Fl_Double_Window {
public:
...
class KTooltip : public Fl_Double_Window {
public:
...
class KPopover : public Fl_Double_Window {
public:
...
class KModalDialog : public Fl_Double_Window {
public:
...
class KDrawer : public Fl_Double_Window {
public:
...
class KContextMenu : public Fl_Double_Window {
public:
