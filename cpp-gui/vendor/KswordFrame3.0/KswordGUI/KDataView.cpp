...
void KKeyValueTable::draw() {
    ...
    fl_color(t.controlBg); fl_rectf(x() + 1, y() + 1, w() - 2, row_h); DrawText(key_header_, x() + 8, y(), split - 12, row_h, t.text, FL_ALIGN_LEFT, kTitleFont); DrawText(value_header_, x() + split + 8, y(), w() - split - 16, row_h, t.text, FL_ALIGN_LEFT, kTitleFont);
