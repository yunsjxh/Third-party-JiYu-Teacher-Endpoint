...
KToast::KToast(int x, int y, int w, int h, const char* label)
    : Fl_Double_Window(x, y, w, h, label ? label : ""), text_(label ? label : ""), kind_(KToastKind::Info), duration_(3.0), accent_color_(FL_BACKGROUND_COLOR) {
...
KTooltip::KTooltip(int x, int y, int w, int h, const char* label)
    : Fl_Double_Window(x, y, w, h, label ? label : ""), text_(label ? label : "") {
...
KPopover::KPopover(int x, int y, int w, int h, const char* label)
    : Fl_Double_Window(x, y, w, h, label ? label : ""), title_(label ? label : ""), content_() {
...
KModalDialog::KModalDialog(int x, int y, int w, int h, const char* label)
    : Fl_Double_Window(x, y, w, h, label ? label : "Dialog"), title_(label ? label : "Dialog"), message_(), primary_text_("OK"), secondary_text_("Cancel"), result_(-1) {
...
KDrawer::KDrawer(int x, int y, int w, int h, const char* label)
    : Fl_Double_Window(x, y, w, h, label ? label : "Drawer"), title_(label ? label : "Drawer"), content_(), side_(KDrawerSide::Right) {
...
KContextMenu::KContextMenu(int x, int y, int w, int h, const char* label)
    : Fl_Double_Window(x, y, w, h, label ? label : ""), items_(), active_index_(-1), selected_index_(-1), row_height_(28) {
